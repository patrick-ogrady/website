...
Vilmo, the key-value database that manages state on the HyperSDK, is an answer to the question: what if we don't care about all of these properties? Specifically, what if we (1) don't need to prove the value of arbitrary keys in state?
